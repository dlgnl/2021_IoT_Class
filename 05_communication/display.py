...
SEGMENT_PIN_red = [7,8,11,10,9,6,12]       # red team segment 핀 설정
...
SEGMENT_PIN_blue = [16,17,20,19,18,15,14]      # blue team segment 핀 설정
...
for i in range(len(SEGMENT_PIN_red)):                                
            GPIO.output(SEGMENT_PIN_red[i], data[0][i])

for i in range(len(SEGMENT_PIN_blue)):                                
            GPIO.output(SEGMENT_PIN_blue[i], data[0][i])
try:
